...
def generate(dataset, scaler_x_name, scaler_y_name):
    ...
    dataset =dataset.rename(columns = {'timestamp':'Date'})
    ...
    joblib.dump(scaler_x, os.path.join('.cache/', scaler_x_name)) 
    joblib.dump(scaler_y, os.path.join('.cache/', scaler_y_name)) 
    ...
    model_lstm.save(".cache/my_model")